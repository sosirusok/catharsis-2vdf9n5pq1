  ...
  return (
    <main className="admin-shell">
      <aside className="admin-sidebar">
        <Link className="admin-logo" href="/"><span>C</span><div><strong>카타르시스</strong><small>RESERVATION ADMIN</small></div></Link>
      ...
      <section className="admin-workspace">
        <header className="admin-topbar"><div><p>카타르시스 이스케이프</p><h1>{tabNames[tab]}</h1></div><div className="admin-top-actions"><a href="/" target="_blank">공개 사이트 보기</a><button type="button" onClick={lockAdmin}>관리 화면 잠그기</button></div></header>
